# this file is a file pytest recognizes automatically,
# it is where we put fixtures and other tests setups that we might want avaliable in other test files
